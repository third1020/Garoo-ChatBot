...
export default class CheckSick extends React.Component {
  ...
  componentWillMount() {
    ...
    const { askName,tellStory1} = steps;


    this.setState({ askName,tellStory1});


                      word = tellStory1.value;
                      name = askName.value;
  ...
  render() {
    const { askName,tellStory1} = this.state;
  ...
  if(ggwp ==="ต้องการให้ช่วยไหม"){  return (
      ...
      return (
                ...
                <Text> ฉันขอให้คุณหายป่วยแล้วกลับมาแข็งแรงในเร็ววันนะ{name}💪 หากไม่ต้องการทำแบบประเมินก็ให้กดปุ่มไม่ต้องการนะ ^3^</Text>
