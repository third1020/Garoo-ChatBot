...
export default class CheckFeel extends React.Component {
  ...
  componentWillMount() {
    ...
    const { askName,whyYouFeelType} = steps;


    this.setState({ askName,whyYouFeelType});


                      word = whyYouFeelType.value;
                      name = askName.value;
  ...
  if(ggwp ==="ต้องการให้ช่วยไหม"){  return (
      ...
      return (
                ...
                <Text>ความรู้สึกตอนนี้ของคุณไม่น่าเสี่ยงต่อการเป็นโรคซึมเศร้านะ หากไม่ต้องการทำแบบประเมินก็ให้กดปุ่มไม่ต้องการนะ ^3^ </Text>
